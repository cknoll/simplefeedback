...
"""
This script serves to deploy and maintain the django app `simplefeedback` on an uberspace account.
...
# TODO: review
init_fixture_path = os.path.join(target_deployment_path, "base/testdata/fixtures01.json")
...
def generate_static_files(c):
    ...
    c.chdir(f"/var/www/virtual/{user}/{django_base_domain}")
